...
ilmerge.exe /out:mvCentral.dll mvCentral_UNMERGED.dll Nlog.dll cornerstone.dll /targetplatform:v4,"%PROGS%\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.7.2" /allowdup
