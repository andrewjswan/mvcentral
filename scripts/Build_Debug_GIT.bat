@echo off
cls
Title Building MediaPortal mvCentral (DEBUG)
cd ..
...
%MSBUILD_PATH% /target:Rebuild /property:Configuration=DEBUG /fl /flp:logfile=mvCentral.log;verbosity=diagnostic mvCentral.sln
